...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'periode_bln'); ?>
		<?php echo $form->textField($model,'periode_bln'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'periode_thn'); ?>
		<?php echo $form->textField($model,'periode_thn'); ?>
	</div>
