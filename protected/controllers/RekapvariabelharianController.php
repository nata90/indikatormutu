...
class RekapvariabelharianController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['RekapVariabelHarian']))
		{
			$model->attributes=$_POST['RekapVariabelHarian'];
			if($model->save())
				$this->redirect(array('view','id'=>$model->id_rekapvariabel_hr));
		}
	...
	{
		$dataProvider=new CActiveDataProvider('RekapVariabelHarian');
	...
	{	
		$tgl_data			= $_GET['tgl_data'];
		$id_variabel_satker	= $_GET['variabelsatker'];
		$nilai 				= $_GET['nilai'];
		$today				= date('Y-m-d');
		$cekUpdate			= RekapVariabelHarian::model()->findByAttributes(array('tgl_data'=>$tgl_data,'id_variabel_satker'=>$id_variabel_satker, 'nilai_variabel_hr'=>$nilai));
		if($cekUpdate!=null){
//+++++++++++++++++++++++++++++Update+++++++++++++++++++++++++++++++++
...
//+++++++++++++++++++++++++++++Update+++++++++++++++++++++++++++++++++
		...
		//+++++++++++++++++++++++++++++Input+++++++++++++++++++++++++++++++++
				...
				$model->tgl_data			= date('Y-m-d', strtotime($tgl_data));
				$model->nilai_variabel_hr	= $nilai;
				$model->tgl_input_hr		= $today;
	...
	public function actionGetDataHarian(){
		...
		$rows['html'] = $this->renderPartial('ajax_laporan_harian',array(
			'model'=>$model,
			'model2'=>$model2,
			'jumlahHari'=>$jumlahHari,
			'bulan'=>$bulan,
	 ...
	 * @return RekapVariabelHarian the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=RekapVariabelHarian::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param RekapVariabelHarian $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='rekap-variabel-harian-form')
		{
