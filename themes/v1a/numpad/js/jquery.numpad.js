    ...
    $.fn.numpad=function(options){
		...
		return this.each(function(){
			...
			if ($('#'+id).length == 0) {
				...
				// var display = $(options.displayTpl).addClass('nmpd-display').createAttribute("placeholder");
				var display = $(options.displayTpl).addClass('nmpd-display').attr("placeholder", "Masukkan Nomor RM");
				// element.setAttribute("placeholder", "aaaaaaaaaaa")
...
// att.value = "https://www.w3schools.com";
				...
				table.append(
					$(options.rowTpl)
						.append($(options.cellTpl).append($(options.buttonNumberTpl).html(7).addClass('numero').addClass('btn-lebar')))
						.append($(options.cellTpl).append($(options.buttonNumberTpl).html(8).addClass('numero').addClass('btn-lebar')))
						.append($(options.cellTpl).append($(options.buttonNumberTpl).html(9).addClass('numero').addClass('btn-lebar')))
					...
					$(options.rowTpl)
						.append($(options.cellTpl).append($(options.buttonNumberTpl).html(4).addClass('numero').addClass('btn-lebar')))
						.append($(options.cellTpl).append($(options.buttonNumberTpl).html(5).addClass('numero').addClass('btn-lebar')))
						.append($(options.cellTpl).append($(options.buttonNumberTpl).html(6).addClass('numero').addClass('btn-lebar')))
						.append($(options.cellTpl).append($(options.buttonFunctionTpl).html(options.textClear).addClass('clear').click(function(){
							nmpd.setValue('');
						})))
					).append(
					$(options.rowTpl)
						.append($(options.cellTpl).append($(options.buttonNumberTpl).html(1).addClass('numero').addClass('btn-lebar')))
						.append($(options.cellTpl).append($(options.buttonNumberTpl).html(2).addClass('numero').addClass('btn-lebar')))
						.append($(options.cellTpl).append($(options.buttonNumberTpl).html(3).addClass('numero').addClass('btn-lebar')))
					...
					$(options.rowTpl)
						...
						.append($(options.cellTpl).append($(options.buttonNumberTpl).html(0).addClass('numero').addClass('btn-lebar')))
	...
	*/
	...
	$.fn.numpad.defaults = {
		...
		rowTpl: '<tr></tr>',
		cellTpl: '<td></td>',
		buttonNumberTpl: '<button name="aaaaaaaaaaaaaa" ></button>',
