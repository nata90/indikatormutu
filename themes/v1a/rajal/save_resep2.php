...
$sql = "INSERT INTO t_resep (IDXDAFTAR, NORESEP, TANGGAL,KDDOKTER, KDPOLY, NOMR, KETERANGAN, NIP, STATUS, RAJAL) VALUES('$_POST[txtIdxDaftar]','$maxnorsp',  now(),'$_POST[txtKdDokter]','$_POST[txtKdPoly]','$_POST[txtNoMR]','$_POST[keterangan]','$_POST[txtNip]','0','1')";
